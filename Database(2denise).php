...
$denkkeuze = mysqli_real_escape_string ($mysql, $_POST["denkkeuze"]);
...
$watwiljeover10jaar = mysqli_real_escape_string ($mysql, $_POST["watwiljeover10jaar"])

// Hier wordt het wachtwoord gewijzigd in de database
mysqli_query($mysql,"INSERT INTO pop (naam, schooljaar1, schooljaar2, klas, mentor, geboortedatum, hobbys, sport, bijbaan, vrienden, gevoel, beschrijf, goeievakken, slechtevakken, makkelijkvrienden, presenteren, opkomen, docentvragen, werkhoudingles, werkhoudingthuis, toetsen, werktempoles, plannen, spullen, vragendocent, maakwerk, leerwerk, initiatief, samenwerken, communicatieD, communicatieM, communicatieL, concentratie, concentratieT, presentatie, extreem, geweldig, prima, goed, beetje, klein, kleur, leerstijl, verwachting, denkstijl, denkkeuze, verwachtingen, watleren, wathalen, watnodig, vak1, vak1tevreden, vak1bereiken, vak1werken, vak1helpen, vak1tijd, vak2, vak2tevreden, vak2bereiken, vak2werken, vak2helpen, vak2tijd, vak3, vak3tevreden, vak3bereiken, vak3werken, vak3helpen, vak3tijd, sociaal, sociaalbereiken, sociaalwerken, sociaalhelpen, sociaaltijd, studie, studiebereiken, studiewerken, studiehelpen, studietijd, watwiljeover10jaar) VALUES ('$naam', '$schooljaar1', '$schooljaar2', '$klas', '$mentor', '$geboortedatum', '$hobbys', '$sport', '$bijbaan', '$vrienden', '$gevoel', '$beschrijf', '$goeievakken', '$slechtevakken', '$makkelijkvrienden', '$presenteren', '$opkomen', '$docentvragen', '$werkhoudingles', '$werkhoudingthuis', '$toetsen', '$werktempoles', '$plannen', '$spullen', '$vragendocent', '$maakwerk', '$leerwerk', '$initiatief', '$samenwerken', '$communicatieD', '$communicatieM', '$communicatieL', '$concentratie', '$concentratieT', '$presentatie', '$extreem', '$geweldig', '$prima', '$goed', '$beetje', '$klein', '$kleur', '$leerstijl', '$verwachting', '$denkstijl', '$denkkeuze', '$verwachtingen', '$watleren', '$wathalen', '$watnodig', '$vak1', '$vak1tevreden', '$vak1bereiken', '$vak1werken', '$vak1helpen', '$vak1tijd', '$vak2', '$vak2tevreden', '$vak2bereiken', '$vak2werken', '$vak2helpen', '$vak2tijd', '$vak3', '$vak3tevreden', '$vak3bereiken', '$vak3werken', '$vak3helpen', '$vak3tijd', '$sociaal', '$sociaalbereiken', '$sociaalwerken', '$sociaalhelpen', '$sociaaltijd', '$studie', '$studiebereiken', '$studiewerken', '$studiehelpen', '$studietijd', '$watwiljeover10jaar')")or die("De insertquery op de database is mislukt!".mysqli_error($mysql));
